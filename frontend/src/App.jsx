...
function App() {
  ...
  const summarizeDocument = async (filename) => {
    ...
    const confirmContinue = window.confirm(
      "Sumarizarea poate dura mai mult timp (până la câteva minute) în special pentru documentele mari. Doriți să continuați?"
    );
    if (!confirmContinue) {
      return;
    }
      ...
      >
        ...
        >
          ...
          >
            ...
            <p
              style={{ margin: "0 0 24px", color: currentTheme.textSecondary }}
            >
              PDF-uri de maxim 20MB. Vom extrage textul și le vom stoca pentru a
              genera rezumate rapide.
            </p>
          ...
          >
            ...
            >
              ...
              <span
                style={{ color: currentTheme.textSecondary, fontWeight: "700" }}
              >
            ...
            {documents.length === 0 ? (
              <p
                style={{ marginTop: "22px", color: currentTheme.textSecondary }}
              >
        ...
        >
          ...
          >
            <div>
              ...
              <p style={{ margin: 0, color: currentTheme.textSecondary }}>
                Alege documentul și generează un rezumat tip articol web, gata
                pentru notițele tale.
              </p>
            </div>
                ...
                chatHistory.map((msg, i) => (
                  ...
                  >
                    ...
                    {msg.status && !msg.content && (
                      <div
                        className={
                          darkMode ? "shimmer-text-dark" : "shimmer-text-light"
                        }
